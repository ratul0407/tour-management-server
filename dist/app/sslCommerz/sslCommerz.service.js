...
const sslPaymentInit = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = {
            ...
            ipn_ur: env_1.envVars.SSL_IPN_URL,
            shipping_method: "N/A",
...
const validatePayment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield (0, axios_1.default)({
            method: "GET",
            url: `${env_1.envVars.SSL_VALIDATION_API}?val_id=${payload.val_id}&store=${env_1.envVars.SSL_STORE_ID}&store_passwd=${env_1.envVars.SSL_STORE_PASSWORD}`,
        });
        console.log("ssl commerz validate api response", response.data);
        yield payment_model_1.Payment.findOneAndUpdate({ transactionId: payload.tran_id }, { paymentGatewayData: response.data }, { runValidators: true });
    }
    catch (error) {
