  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const updatedBooking = yield booking_model_1.Booking.findByIdAndUpdate(
        updatedPayment === null || updatedPayment === void 0
          ? void 0
      ...
      const cloudinaryResult = yield (0,
      cloudinary_config_1.uploadBufferToCloudinary)(pdfBuffer, "invoice");
      console.log(cloudinaryResult, "from line 61");
      if (!cloudinaryResult) {
        throw new appError_1.default(401, "Error uploading pdf");
      }
      const setInvoice = yield payment_model_1.Payment.findByIdAndUpdate(
        updatedPayment._id,
        {
...
const failPayment = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      yield booking_model_1.Booking.findByIdAndUpdate(
        updatedPayment === null || updatedPayment === void 0
          ? void 0
          : updatedPayment.booking,
        {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!payment) {
      throw new appError_1.default(
        ...
        "Payment Not Found. You haven't booked this tour."
      );
    }
    const booking = yield booking_model_1.Booking.findById(payment.booking);
    const userAddress = (
      booking === null || booking === void 0 ? void 0 : booking.user
    ).address;
    const userEmail = (
      booking === null || booking === void 0 ? void 0 : booking.user
    ).email;
...
const getInvoiceDownloadUrl = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const payment = yield payment_model_1.Payment.findById(id).select(
      "invoiceUrl"
    );
    if (!payment) {
      throw new appError_1.default(401, "Payment not found");
