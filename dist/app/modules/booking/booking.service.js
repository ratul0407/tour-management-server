...
const getUserBookings = (token, query) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId } = token;
    const user = yield user_model_1.User.findOne({ _id: userId });
    const queryBuilder = yield new queryBuilder_1.QueryBuilder(booking_model_1.Booking.find({ _id: { $in: user === null || user === void 0 ? void 0 : user.bookings } }), query);
