...
const sendEmail = (_a) => __awaiter(void 0, [_a], void 0, function* ({ to, templateData, subject, attachments, templateName, }) {
    try {
        const templatePath = node_path_1.default.join(__dirname, `templates/${templateName}.ejs`);
